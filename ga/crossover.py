...
class Crossover:
    ...
    Instances of :class:`.Population` delegate crossover operations
    to instances of this class. They do this by calling

    >>> offspring_pop = pop.gen_offspring()

    where ``offspring_pop`` is a new :class:`.Population`, holding
    ...
    def __call__(self, population, counter_path=''):
        ...
        :class:`.Population` instance. Any molecules that are created
