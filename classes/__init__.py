...
from .topology import SixPlusEight, TwoPlusThree, TenPlusTwenty, ThreePlusSix, TwoPlusFour, FourPlusSix, EightPlusTwelve, SixPlusNine, Dodecahedron, FourPlusEight, SixPlusTwelve, TwoPlusTwo
