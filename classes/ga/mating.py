...
class Mating:
    ...
    Instance of the ``Population`` class delegate mating operations to
    instances of this class. They do this by calling:
        
        >> offspring_pp = pop.gen_offspring()
    ...
    invokes the an instance of the ``Selection`` class to select the
    ...
    Members of this class are also initialized with an iteger which
