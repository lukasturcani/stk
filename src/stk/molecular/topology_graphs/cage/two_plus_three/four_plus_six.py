...
class FourPlusSix(Cage):
    ...
    *Multi-Building Block Cage Construction*, a
    ...
    _vertex_prototypes = (
        *_vertex_prototypes,
        LinearCageVertex.init_at_center(4, (_v0, _v1)),
        LinearCageVertex.init_at_center(5, (_v0, _v2)),
        LinearCageVertex.init_at_center(6, (_v0, _v3)),
        LinearCageVertex.init_at_center(7, (_v1, _v2)),
        LinearCageVertex.init_at_center(8, (_v1, _v3)),
        LinearCageVertex.init_at_center(9, (_v2, _v3)),
    )
