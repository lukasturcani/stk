...
class EightPlusTwelve(Cage):
    ...
    *Multi-Building Block Cage Construction*, a
    ...
    _vertex_prototypes = (
        NonLinearCageVertex(0, [-1, 1, -1]),
        NonLinearCageVertex(1, [-1, -1, -1]),
        NonLinearCageVertex(2, [1, 1, -1]),
        NonLinearCageVertex(3, [1, -1, -1]),

        NonLinearCageVertex(4, [-1, 1, 1]),
        NonLinearCageVertex(5, [-1, -1, 1]),
        NonLinearCageVertex(6, [1, 1, 1]),
        NonLinearCageVertex(7, [1, -1, 1])
    )
