...
class SixPlusTwelve(Cage):
    ...
    *Multi-Building Block Cage Construction*, a
    ...
    _vertex_prototypes = (
        NonLinearCageVertex(0, [-1, -1, 0]),
        NonLinearCageVertex(1, [-1, 1, 0]),
        NonLinearCageVertex(2, [1, -1, 0]),
        NonLinearCageVertex(3, [1, 1, 0]),
        NonLinearCageVertex(4, [0, 0, 1]),
        NonLinearCageVertex(5, [0, 0, -1]),
    )
