    ...
    *Multi-Building Block Cage Construction*, a
    ...
    Examples:
        ...
        *Building a Metal-Organic Tetrahedron*
        ...
        the same as the experimental reaction. Instead of forming bonds
        at the metal centre, we create bonds between disconnected
        ligands. Firstly, we define the disconnected linker molecule,
        where we have added a bromine atom at the disconnection to
        perform the cage reaction.
        ...
        process completes all metal-ligand reactions performed during
        the subcomponent self-assembly process.
    ...
    def clone(self) -> M4L6Tetrahedron:
        return self._clone()
