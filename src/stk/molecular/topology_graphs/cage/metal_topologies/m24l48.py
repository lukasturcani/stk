...
class M24L48(Cage):
    ...
    *Multi-Building Block Cage Construction*, a
    ...
    _vertex_prototypes = (
        NonLinearCageVertex(0, [_coord1, _coord1, _coord4]),
        NonLinearCageVertex(1, [_coord1, _coord1, _coord5]),
        NonLinearCageVertex(2, [_coord1, _coord4, _coord2]),
        NonLinearCageVertex(3, [_coord1, _coord5, _coord2]),
        NonLinearCageVertex(4, [_coord1, _coord2, _coord4]),
        NonLinearCageVertex(5, [_coord1, _coord2, _coord5]),
        NonLinearCageVertex(6, [_coord1, _coord4, _coord1]),
        NonLinearCageVertex(7, [_coord1, _coord5, _coord1]),
        NonLinearCageVertex(8, [_coord2, _coord1, _coord4]),
        NonLinearCageVertex(9, [_coord2, _coord1, _coord5]),
        NonLinearCageVertex(10, [_coord2, _coord2, _coord4]),
        NonLinearCageVertex(11, [_coord2, _coord2, _coord5]),
        NonLinearCageVertex(12, [_coord2, _coord4, _coord1]),
        NonLinearCageVertex(13, [_coord2, _coord5, _coord1]),
        NonLinearCageVertex(14, [_coord2, _coord4, _coord2]),
        NonLinearCageVertex(15, [_coord2, _coord5, _coord2]),
        NonLinearCageVertex(16, [_coord4, _coord1, _coord1]),
        NonLinearCageVertex(17, [_coord4, _coord2, _coord1]),
        NonLinearCageVertex(18, [_coord4, _coord2, _coord2]),
        NonLinearCageVertex(19, [_coord4, _coord1, _coord2]),
        NonLinearCageVertex(20, [_coord5, _coord1, _coord1]),
        NonLinearCageVertex(21, [_coord5, _coord2, _coord1]),
        NonLinearCageVertex(22, [_coord5, _coord2, _coord2]),
        NonLinearCageVertex(23, [_coord5, _coord1, _coord2]),

        LinearCageVertex(24, [_coord1, _coord3, _coord4], False),
        LinearCageVertex(25, [_coord1, _coord4, _coord3], False),
        LinearCageVertex(26, [_coord1, _coord3, _coord5], False),
        LinearCageVertex(27, [_coord1, _coord5, _coord3], False),
        LinearCageVertex(28, [_coord2, _coord3, _coord4], False),
        LinearCageVertex(29, [_coord2, _coord4, _coord3], False),
        LinearCageVertex(30, [_coord2, _coord3, _coord5], False),
        LinearCageVertex(31, [_coord2, _coord5, _coord3], False),

        LinearCageVertex(32, [_coord3, _coord1, _coord4], False),
        LinearCageVertex(33, [_coord4, _coord1, _coord3], False),
        LinearCageVertex(34, [_coord3, _coord1, _coord5], False),
        LinearCageVertex(35, [_coord5, _coord1, _coord3], False),
        LinearCageVertex(36, [_coord3, _coord2, _coord4], False),
        LinearCageVertex(37, [_coord4, _coord2, _coord3], False),
        LinearCageVertex(38, [_coord3, _coord2, _coord5], False),
        LinearCageVertex(39, [_coord5, _coord2, _coord3], False),

        LinearCageVertex(40, [_coord3, _coord4, _coord1], False),
        LinearCageVertex(41, [_coord4, _coord3, _coord1], False),
        LinearCageVertex(42, [_coord3, _coord5, _coord1], False),
        LinearCageVertex(43, [_coord5, _coord3, _coord1], False),
        LinearCageVertex(44, [_coord3, _coord4, _coord2], False),
        LinearCageVertex(45, [_coord4, _coord3, _coord2], False),
        LinearCageVertex(46, [_coord3, _coord5, _coord2], False),
        LinearCageVertex(47, [_coord5, _coord3, _coord2], False),

        LinearCageVertex(48, [_coord1, _coord6, _coord6], False),
        LinearCageVertex(49, [_coord1, _coord6, -_coord6], False),
        LinearCageVertex(50, [_coord1, -_coord6, _coord6], False),
        LinearCageVertex(51, [_coord1, -_coord6, -_coord6], False),
        LinearCageVertex(52, [_coord2, _coord6, _coord6], False),
        LinearCageVertex(53, [_coord2, _coord6, -_coord6], False),
        LinearCageVertex(54, [_coord2, -_coord6, _coord6], False),
        LinearCageVertex(55, [_coord2, -_coord6, -_coord6], False),

        LinearCageVertex(56, [_coord6, _coord1, _coord6], False),
        LinearCageVertex(57, [_coord6, _coord1, -_coord6], False),
        LinearCageVertex(58, [-_coord6, _coord1, _coord6], False),
        LinearCageVertex(59, [-_coord6, _coord1, -_coord6], False),
        LinearCageVertex(60, [_coord6, _coord2, _coord6], False),
        LinearCageVertex(61, [_coord6, _coord2, -_coord6], False),
        LinearCageVertex(62, [-_coord6, _coord2, _coord6], False),
        LinearCageVertex(63, [-_coord6, _coord2, -_coord6], False),

        LinearCageVertex(64, [_coord6, _coord6, _coord1], False),
        LinearCageVertex(65, [_coord6, -_coord6, _coord1], False),
        LinearCageVertex(66, [-_coord6, _coord6, _coord1], False),
        LinearCageVertex(67, [-_coord6, -_coord6, _coord1], False),
        LinearCageVertex(68, [_coord6, _coord6, _coord2], False),
        LinearCageVertex(69, [_coord6, -_coord6, _coord2], False),
        LinearCageVertex(70, [-_coord6, _coord6, _coord2], False),
        LinearCageVertex(71, [-_coord6, -_coord6, _coord2], False),
    )
