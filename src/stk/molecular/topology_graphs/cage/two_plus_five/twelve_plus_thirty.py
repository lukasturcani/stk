...
class TwelvePlusThirty(Cage):
    ...
    *Multi-Building Block Cage Construction*, a
    ...
    _vertex_prototypes = (
        NonLinearCageVertex(0, [0, 1, golden]),
        NonLinearCageVertex(1, [0, -1, golden]),
        NonLinearCageVertex(2, [0, 1, -golden]),
        NonLinearCageVertex(3, [0, -1, -golden]),
        NonLinearCageVertex(4, [1, golden, 0]),
        NonLinearCageVertex(5, [-1, golden, 0]),
        NonLinearCageVertex(6, [1, -golden, 0]),
        NonLinearCageVertex(7, [-1, -golden, 0]),
        NonLinearCageVertex(8, [golden, 0, 1]),
        NonLinearCageVertex(9, [-golden, 0, 1]),
        NonLinearCageVertex(10, [golden, 0, -1]),
        NonLinearCageVertex(11, [-golden, 0, -1])
    )
