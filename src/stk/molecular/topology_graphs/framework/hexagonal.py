...
class Hexagonal(Framework):
    """
    Represents a hexagonal framework topology graph.
    ...
    _vertex_prototypes = (
        _NonLinearFrameworkVertex(0, (1/4)*_a + (1/4)*_b + (1/2)*_c),
        _NonLinearFrameworkVertex(1, (1/4)*_a + (3/4)*_b + (1/2)*_c),
        _NonLinearFrameworkVertex(2, (3/4)*_a + (1/4)*_b + (1/2)*_c),
        _NonLinearFrameworkVertex(3, (3/4)*_a + (3/4)*_b + (1/2)*_c),
    )

    _vertex_prototypes = (
        *_vertex_prototypes,
        _LinearFrameworkVertex.init_at_center(
            id=4,
