...
class M6L6L12Cuboctahedron(Cage):
    ...
    *Multi-Building Block Cage Construction*, a
    ...
    _edge_prototypes = (
        ...
        # Inner shell
        Edge(23, _vertex_prototypes[0], _vertex_prototypes[18]),
        Edge(24, _vertex_prototypes[0], _vertex_prototypes[21]),
        Edge(25, _vertex_prototypes[0], _vertex_prototypes[22]),
        Edge(26, _vertex_prototypes[0], _vertex_prototypes[25]),
        Edge(27, _vertex_prototypes[1], _vertex_prototypes[18]),
        Edge(28, _vertex_prototypes[1], _vertex_prototypes[19]),
        Edge(29, _vertex_prototypes[1], _vertex_prototypes[22]),
        Edge(30, _vertex_prototypes[1], _vertex_prototypes[23]),
        Edge(31, _vertex_prototypes[2], _vertex_prototypes[19]),
        Edge(32, _vertex_prototypes[2], _vertex_prototypes[20]),
        Edge(33, _vertex_prototypes[2], _vertex_prototypes[23]),
        Edge(34, _vertex_prototypes[2], _vertex_prototypes[24]),
        Edge(35, _vertex_prototypes[3], _vertex_prototypes[20]),
        Edge(36, _vertex_prototypes[3], _vertex_prototypes[21]),
        Edge(37, _vertex_prototypes[3], _vertex_prototypes[24]),
        Edge(38, _vertex_prototypes[3], _vertex_prototypes[25]),
        Edge(39, _vertex_prototypes[4], _vertex_prototypes[18]),
        Edge(40, _vertex_prototypes[4], _vertex_prototypes[19]),
        Edge(41, _vertex_prototypes[4], _vertex_prototypes[20]),
        Edge(42, _vertex_prototypes[4], _vertex_prototypes[21]),
        Edge(43, _vertex_prototypes[5], _vertex_prototypes[22]),
        Edge(44, _vertex_prototypes[5], _vertex_prototypes[23]),
        Edge(45, _vertex_prototypes[5], _vertex_prototypes[24]),
        Edge(46, _vertex_prototypes[5], _vertex_prototypes[25]),
    )
