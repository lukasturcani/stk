...
def filter_batches_population_1() -> dict[stk.MoleculeRecord[Any], float]:
    return {
        stk.MoleculeRecord(
...
def filter_batches(
    ...
    filter_batches_population_1: dict[stk.MoleculeRecord[Any], float],
) -> CaseData:
    return request.param(filter_batches_population_1)
