...
@pytest.fixture
def framework2(init_at_center, id, vertices_, aligner_edge, cell):
    return CaseData(
...
@pytest.fixture(
    params=(
        vertices._LinearFrameworkVertex.init_at_center,
        vertices._NonLinearFrameworkVertex.init_at_center,
    ),
)
