    ...
    params=(
        ...
        CaseData.init_constructed_molecule(
            building_blocks=(
                ...
                stk.BuildingBlock(
                    smiles=(
                        'Br[C+]1[C+]2[N+][C+2]C2(Br)[C+](I)[C+](I)[C+](Br)'
                        '[C+]1Br'
                    ),
                    functional_groups=[
                        stk.BromoFactory(),
                ...
                stk.BuildingBlock(
                    smiles=(
                        'Br[C+]1[C+]2[S][C+2]C2(Br)[C+](I)[C+](I)[C+](Br)'
                        '[C+]1Br'
                    ),
                    functional_groups=[
                        stk.BromoFactory(),
                ...
                stk.BuildingBlock(
                    smiles=(
                        'Br[C+]1[C+]2[S][O]C2(Br)[C+](I)[C+](I)[C+](Br)'
                        '[C+]1Br'
                    ),
                    functional_groups=[
                        stk.BromoFactory(),
        ...
        CaseData.init_constructed_molecule(
            ...
            smiles=(
                'C12[CH+][C+2][C+]13[C+2][C+]1[C+2][C+]2C2=C([C+]=[C+]'
                '2)[C+]2[C+2][C+]4C5=C(N=[C+]5)[C+]5[C+2][C+]([C+2][C+'
                ']6([C+2][CH+]C56)C5=C([C+]=[C+]5)[C+]5[C+2][C+]([C+2]'
                '[C+]6([C+2][CH+]C56)C5=C([C+]=[C+]5)[C+]5([C+2]2)[C+2'
                '][C+](F)C45)C2=C1[C+]=[C+]2)C1=C3[C+]=[C+]1'
            ),
        ),
    ),
)
