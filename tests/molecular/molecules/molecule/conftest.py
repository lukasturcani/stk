...
@pytest.fixture(
    params=(
        ...
        CaseData.init_constructed_molecule(
            ...
            smiles=(
                '[H]C12[CH+][C+2][C+]13[C+2][C+]1[C+2][C+]2C2=C([C+]=['
                'C+]2)[C+]2[C+2][C+]4C5=C(N=[C+]5)[C+]5[C+2][C+]([C+2]'
                '[C+]6([C+2][CH+]C56[H])C5=C([C+]=[C+]5)[C+]5[C+2][C+]'
                '([C+2][C+]6([C+2][CH+]C56[H])C5=C([C+]=[C+]5)[C+]5([C'
                '+2]2)[C+2][C+](F)C45[H])C2=C1[C+]=[C+]2)C1=C3[C+]=[C+'
                ']1'
            ),
        ),
    ),
